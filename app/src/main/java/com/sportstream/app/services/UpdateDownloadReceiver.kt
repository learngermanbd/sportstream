 ...
 * [com.sportstream.app.data.update.AppUpdateManager] downloads the APK
...
class UpdateDownloadReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        // runCatching { ... as? SportStreamApp } pattern that silently
        ...
        val app = try {
            context.applicationContext as com.sportstream.app.SportStreamApp
        } catch (e: ClassCastException) {
            Log.w(
                "UpdateDownloadReceiver",
                "Application not yet a SportStreamApp; skipping update trigger"
            )
            return
        }
