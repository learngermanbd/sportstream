 ...
 * builder's contentIntent. The deep-link URI format (`sportstream://...`)
...
object NotificationHelper {
     ...
     * [SportStreamApp.onCreate] AND from [SportStreamMessagingService.onCreate]
     ...
     * @param deepLinkUri    Optional `sportstream://...` deep link. When
    ...
    fun showLiveEventNotification(
        ...
        val tapIntent = Intent(Intent.ACTION_VIEW).apply {
            data = deepLinkUri ?: Uri.parse("sportstream://main")
