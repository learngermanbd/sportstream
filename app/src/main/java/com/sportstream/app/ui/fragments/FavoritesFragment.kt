...
import com.sportstream.app.data.local.FavoriteEntity
import com.sportstream.app.databinding.FragmentFavoritesBinding
import com.sportstream.app.ui.adapters.FavoriteAdapter
import com.sportstream.app.ui.common.UiState
import com.sportstream.app.ui.util.PlayerNavigation
import com.sportstream.app.ui.viewmodels.FavoritesViewModel
    ...
    private fun attachSwipeToDelete(recycler: RecyclerView) {
        val swipeBackground = ColorDrawable(
            ContextCompat.getColor(
                requireContext(),
                com.sportstream.app.R.color.swipe_delete_background
            )
        )
        val callback = object : ItemTouchHelper.SimpleCallback(
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                Snackbar.make(
                    binding.root,
                    getString(com.sportstream.app.R.string.favorites_removed_template, entity.name),
                    Snackbar.LENGTH_LONG
                ).setAction(
                    getString(com.sportstream.app.R.string.favorites_action_undo)
