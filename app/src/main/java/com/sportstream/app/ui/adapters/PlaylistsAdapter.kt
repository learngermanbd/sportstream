package com.sportstream.app.ui.adapters
...
import com.sportstream.app.data.local.PlaylistEntity
import com.sportstream.app.databinding.ViewItemPlaylistBinding
    ...
    class PlaylistViewHolder(
        ...
        fun bind(playlist: PlaylistEntity) {
            ...
            binding.playlistName.text = playlist.name.ifBlank {
                ctx.getString(com.sportstream.app.R.string.playlists_default_name)
            }
            binding.playlistItemCount.text = ctx.resources.getQuantityString(
                com.sportstream.app.R.plurals.playlists_item_count,
                playlist.items.size,
                playlist.items.size
            )
