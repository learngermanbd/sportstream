 ...
 * [com.sportstream.app.data.prefs.ThemePrefs]. Future settings rows
 ...
 *      [com.sportstream.app.SportStreamApp.onCreate] as the
...
class SettingsFragment : Fragment() {
     ...
     * 6.4 review point #3).
     */
    private fun onChipTapped(app: SportStreamApp, mode: ThemePrefs.ThemeMode) {
        viewLifecycleOwner.lifecycleScope.launch {
