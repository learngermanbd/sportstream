package com.sportstream.app.ui.common
...
/**
 * Bridges a [com.sportstream.app.data.remote.ApiResult] from the data
 ...
 */
inline fun <T> com.sportstream.app.data.remote.ApiResult<T>.toUiState(
    fallbackMessage: String = "Something went wrong"
): UiState<T> = when (this) {
    is com.sportstream.app.data.remote.ApiResult.Success -> UiState.Success(value)
    is com.sportstream.app.data.remote.ApiResult.Failure ->
