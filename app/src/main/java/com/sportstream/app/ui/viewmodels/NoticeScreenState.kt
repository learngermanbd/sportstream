 ...
 *                   the [com.sportstream.app.ui.adapters.NoticeAdapter]
 *                   RecyclerView.
 *  - [LegacyMode] — single free-form string. Emitted when the v2
 *                   room/network pipeline returns 0 items AND
 *                   [com.sportstream.app.data.remote.AppConfig.noticeText]
 ...
 * to [com.sportstream.app.ui.adapters.NoticeAdapter] which mixes in
