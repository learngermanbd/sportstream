...
import com.sportstream.app.data.local.NoticeDao
import com.sportstream.app.data.local.NoticeEntity
...
class NoticeRepository(
     ...
     * caller falls back to the v1 [com.sportstream.app.data.remote.AppConfig.noticeText]).
     *
     ...
     * [com.sportstream.app.services.SportStreamMessagingService] when
