 ...
 * [com.sportstream.app.SportStreamApp.onCreate] BEFORE any Activity
 ...
 * [com.sportstream.app.SportStreamApp.onCreate] (process-wide), before
...
class ThemePrefs(private val context: Context) {
     ...
     * [com.sportstream.app.SportStreamApp.onCreate] without spinning a
