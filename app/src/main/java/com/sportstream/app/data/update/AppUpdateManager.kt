package com.sportstream.app.data.update
 ...
 *    fetch [com.sportstream.app.data.remote.AppConfig], reduce to
 ...
 *    [com.sportstream.app.services.UpdateDownloadReceiver] (registered
 ...
 * Activity recreation; SportStreamApp holds a single instance as
 * `app.updateManager`.
 */
class AppUpdateManager(
    ...
    companion object {
        ...
        const val APK_FILE_NAME = "sportstream-update.apk"
    }
