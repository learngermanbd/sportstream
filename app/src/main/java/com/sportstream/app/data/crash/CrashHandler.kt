package com.sportstream.app.data.crash
...
import com.sportstream.app.ui.crash.CrashActivity
import java.io.File
 ...
 *
 * Installed once from
 * [com.sportstream.app.SportStreamApp.onCreate] right after the Sentry SDK
...
class CrashHandler private constructor(private val appContext: Context) :
    ...
    override fun uncaughtException(thread: Thread, throwable: Throwable) {
        ...
        // SportStreamApp.onCreate doesn't prevent the user from restarting
        ...
        // SportStreamApp wiring order that is Sentry's handler \u2014
