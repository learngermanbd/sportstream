package com.sportstream.app.security
...
object CodeObfuscationRuntime {
    ...
    object EncryptedClasses {
        ...
        /** "com.sportstream.app.security.SecurityGate" */
        val SECURITY_GATE = encryptName("com.sportstream.app.security.SecurityGate")

        /** "com.sportstream.app.security.SelfHealing" */
        val SELF_HEALING = encryptName("com.sportstream.app.security.SelfHealing")

        /** "com.sportstream.app.security.NativeSecurityManager" */
        val NATIVE_SECURITY = encryptName("com.sportstream.app.security.NativeSecurityManager")
    }
}
